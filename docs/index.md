...
!!! note "Questions?"
    ...
    Join us in the #general-motors channel of the [FrogPilot discord](https://discord.gg/frogpilot). The pinned messages will lead you to the StarPilot threads. (Unfortunately, we can't link directly to threads).
